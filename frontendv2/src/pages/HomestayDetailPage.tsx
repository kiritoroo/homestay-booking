...
export default function HomestayDetailPage() {
  ...
  const truncatedDesc = desc.length > MAX_DESC_LENGTH ? `${desc.slice(0, desc.lastIndexOf(" ", MAX_DESC_LENGTH))} ...` : desc;
  ...
  const images = useMemo<string[]>(() => homestayData ? [
  ...
  useLayoutEffect(() => {
    homestayActions.getByID(homestayId!, homestayGetByIDRequestParams)
          ...
          <S.StyledHomestayInfoContainer>
            ...
            <S.StyledHomestayDescContainer>
              ...
              <S.StyledHomestayDescWrapper>
                <S.StyledHomestayDesc> { homestayData?.homestays[0].homestay.description } </S.StyledHomestayDesc>
                <S.StyledHideWrapper
              ...
              <S.StyledHomestayDescWrapper>
                <S.StyledHomestayDesc> { truncatedDesc } </S.StyledHomestayDesc>
            ...
            <S.StyledHomestaySmallInfoListWrapper>
              ...
              <S.StyledHomestaySmallInfoWrapper>
                <S.StyledIconWrapper> <TbCooker size="25px"/> </S.StyledIconWrapper>
                <S.StyledHomestayInfoTitle>Bếp</S.StyledHomestayInfoTitle>
              </S.StyledHomestaySmallInfoWrapper>

              <S.StyledHomestaySmallInfoWrapper>
                <S.StyledIconWrapper> <MdWifi size="25px"/> </S.StyledIconWrapper>
                <S.StyledHomestayInfoTitle>Wi-fi nhanh - 256 Mbps</S.StyledHomestayInfoTitle>
              </S.StyledHomestaySmallInfoWrapper>

              <S.StyledHomestaySmallInfoWrapper>
                <S.StyledIconWrapper> <MdWorkOutline size="25px"/> </S.StyledIconWrapper>
                <S.StyledHomestayInfoTitle>Không gian riêng để làm việc</S.StyledHomestayInfoTitle>
              </S.StyledHomestaySmallInfoWrapper>

              <S.StyledHomestaySmallInfoWrapper>
                <S.StyledIconWrapper> <MdPets size="25px"/> </S.StyledIconWrapper>
                <S.StyledHomestayInfoTitle>Cho phép thú cưng</S.StyledHomestayInfoTitle>
              </S.StyledHomestaySmallInfoWrapper>

              <S.StyledHomestaySmallInfoWrapper>
                <S.StyledIconWrapper> <MdOutlineDeck size="25px"/> </S.StyledIconWrapper>
                <S.StyledHomestayInfoTitle>Sân hiên hoặc ban công riêng</S.StyledHomestayInfoTitle>
              </S.StyledHomestaySmallInfoWrapper>

              <S.StyledHomestaySmallInfoWrapper>
                <S.StyledIconWrapper> <MdCameraOutdoor size="25px"/> </S.StyledIconWrapper>
